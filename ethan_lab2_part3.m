...
% frequencyOffsetHz = 0.5*sampleRateHz;  % Use for EVM Section!
...
%% EVM Evaluation
% Creation of EVM Object
evm = comm.EVM('ReferenceSignalSource', 'Input Port');
% Calculation of EVM (RMS and dB)
rmsEVM = evm(modulatedData, rxData);
dBEVM = 20*log10(rmsEVM/100);
